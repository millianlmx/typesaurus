...
export declare namespace TypesaurusCore {
    export interface Function {
        <Schema extends PlainSchema, Opts extends Options>(getSchema: ($: SchemaHelpers) => Schema, options?: Opts): DB<Schema>;
    }
    /**
     * Define custom id passing the collection path string as the generic.
     */
    export type Id<Path extends string | symbol | Array<string | symbol>> = string & {
        [idBrand]: Path;
    };
    ...
    export type ModelVariableType = [ModelObjectType] | [ModelObjectType, ModelObjectType] | [ModelObjectType, ModelObjectType, ModelObjectType] | [ModelObjectType, ModelObjectType, ModelObjectType, ModelObjectType] | [
        ModelObjectType,
        ModelObjectType,
        ModelObjectType,
        ModelObjectType,
     ...
     */
    export type DocModel<Def extends DocDef> = Utils.NeverIfEmpty<DocModelShape<Def>>;
    /**
     ...
     */
    export type DocModelOrUnknown<Def extends DocDef> = Utils.UnknownIfEmpty<DocModelShape<Def>>;
    /**
     * Resolves the reduced model or the shared model shape otherwise.
     */
    export type DocModelShape<Def extends DocDef> = Def["Flags"]["Reduced"] extends true ? IntersectVariableModelType<Def["Model"]> : SharedVariableModelType<Def["WideModel"]>;
    export type IntersectVariableModelType<Model extends ModelType> = Model extends ModelObjectType ? Model : Model extends [
    ...
    ] ? Utils.IntersectShape<A, B, C, D, E, F, G, H, I, J> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer H extends ModelObjectType,
        infer I extends ModelObjectType
    ] ? Utils.IntersectShape<A, B, C, D, E, F, G, H, I> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer G extends ModelObjectType,
        infer H extends ModelObjectType
    ] ? Utils.IntersectShape<A, B, C, D, E, F, G, H> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer F extends ModelObjectType,
        infer G extends ModelObjectType
    ] ? Utils.IntersectShape<A, B, C, D, E, F, G> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        infer E extends ModelObjectType,
        infer F extends ModelObjectType
    ] ? Utils.IntersectShape<A, B, C, D, E, F> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        infer E extends ModelObjectType
    ] ? Utils.IntersectShape<A, B, C, D, E> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType
    ] ? Utils.IntersectShape<A, B, C, D> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType
    ] ? Utils.IntersectShape<A, B, C> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType
    ] ? Utils.IntersectShape<A, B> : Model extends [infer A extends ModelObjectType] ? A : never;
    export type SharedVariableModelType<Model extends ModelType> = Model extends ModelObjectType ? Model : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer I extends ModelObjectType,
        infer J extends ModelObjectType
    ] ? Utils.SharedShape10<A, B, C, D, E, F, G, H, I, J> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer H extends ModelObjectType,
        infer I extends ModelObjectType
    ] ? Utils.SharedShape9<A, B, C, D, E, F, G, H, I> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer G extends ModelObjectType,
        infer H extends ModelObjectType
    ] ? Utils.SharedShape8<A, B, C, D, E, F, G, H> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer F extends ModelObjectType,
        infer G extends ModelObjectType
    ] ? Utils.SharedShape7<A, B, C, D, E, F, G> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        infer E extends ModelObjectType,
        infer F extends ModelObjectType
    ] ? Utils.SharedShape6<A, B, C, D, E, F> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        infer E extends ModelObjectType
    ] ? Utils.SharedShape5<A, B, C, D, E> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType
    ] ? Utils.SharedShape4<A, B, C, D> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType
    ] ? Utils.SharedShape3<A, B, C> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType
    ] ? Utils.SharedShape2<A, B> : Model extends [infer A extends ModelObjectType] ? A : never;
    export type UnionVariableModelType<Model extends ModelType> = Model extends [
        ...
        infer I extends ModelObjectType,
        infer J extends ModelObjectType
    ] ? A | B | C | D | E | F | G | H | I | J : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer H extends ModelObjectType,
        infer I extends ModelObjectType
    ] ? A | B | C | D | E | F | G | H | I : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer D extends ModelObjectType,
        infer E extends ModelObjectType
    ] ? A | B | C | D | E : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType
    ] ? A | B | C | D : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType
    ] ? A | B | C : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType
    ] ? A | B : Model extends [infer A extends ModelObjectType] ? A : Model extends ModelObjectType ? Model : never;
    /**
     ...
     */
    export type ConcatModel<ModelToConcatTo extends ModelType, ModelToConcat extends ModelType> = ModelToConcatTo extends ModelObjectType ? ModelToConcat extends ModelObjectType ? [ModelToConcatTo, ModelToConcat] : ModelToConcat extends ModelVariableType ? [ModelToConcatTo, ...ModelToConcat] : never : ModelToConcatTo extends ModelVariableType ? ModelToConcat extends ModelObjectType ? [...ModelToConcatTo, ModelToConcat] : ModelToConcat extends ModelVariableType ? [...ModelToConcatTo, ...ModelToConcat] : never : never;
     ...
     * `query`.
     */
    export interface SubscriptionListMeta<Def extends DocDef, Props extends DocProps> {
        /**
    ...
    export interface ReadOptions<Environment extends RuntimeEnvironment, Props extends DocProps & {
        environment: Environment;
    }> extends DocOptions<Props>, OperationOptions<Environment> {
    }
    export type NarrowDef<Def extends DocDef, ReduceToModel, Flags = Def["Flags"]> = {
        Model: ReduceToModel;
        Id: Def["Id"];
     ...
     */
    export interface Doc<Def extends DocDef, Props extends DocProps> extends DocAPI<Def> {
        type: "doc";
        /** The doc's ref. */
        ref: Ref<Def>;
        data: DocData<Def, Props>;
        readonly props: Props;
        test<Props extends Partial<DocProps>>(props: Props): this is Doc<Def, DocProps & Props>;
        assert<Props extends Partial<DocProps>>(props: Props): asserts this is Doc<Def, DocProps & Props>;
        /**
    ...
    export type AnyData<Model extends ModelObjectType> = Data<Model, ServerDateMissing>;
    /**
     * Doc data type. Defines the shape of the document data returned from the
     * database. It resolves server dates.
     */
    export type Data<Model extends ModelObjectType, DateMissing extends ServerDateMissing> = {
        [Key in keyof Model]: DataField<Model[Key], DateMissing>;
    };
    /**
     * Doc data field. Processes data field types and resolves server dates.
     */
    export type DataField<Type, DateMissing extends ServerDateMissing> = Type extends ServerDate ? DateMissing extends "missing" ? Date | null : Date : Type extends Date | Ref<any> | string | number | boolean | null | undefined ? Type : Type extends Array<infer ItemType> ? Array<DataField<ItemType, DateMissing>> : Type extends object ? Data<Type, DateMissing> : never;
    /**
    ...
    const serverDateBrand: unique symbol;
    export type DocData<Def extends DocDef, Props extends DocProps> = Props["environment"] extends "server" ? ServerData<IntersectVariableModelType<Def["Model"]>> : Props["source"] extends "database" ? Data<IntersectVariableModelType<Def["Model"]>, "present"> : Props["dateStrategy"] extends "estimate" | "previous" ? Data<IntersectVariableModelType<Def["Model"]>, "present"> : Data<IntersectVariableModelType<Def["Model"]>, "missing">;
    /**
    ...
    export interface WriteHelpers<_Model> {
         ...
         */
        increment<NumberType extends number>(value: NumberType): ValueIncrement<NumberType>;
        /**
     ...
     */
    export type AssignArg<Model extends ModelObjectType, Props extends DocProps> = WriteData<Model, Props> | AssignGetter<Model, Props>;
    /**
     * Assign data getter, accepts helper functions and returns the assign data.
     */
    export type AssignGetter<Model extends ModelObjectType, Props extends DocProps> = ($: WriteHelpers<Model>) => WriteData<Model, Props>;
    /**
     ...
     * increment, etc.
     */
    export type WriteData<Model extends ModelObjectType, Props extends DocProps> = {
     ...
     */
    export type WriteField<Parent, Key extends keyof Parent, Type, Props extends DocProps> = Type extends number ? WriteFieldNumber<Parent, Key, Type> : Type extends ServerDate ? WriteFieldServerDate<Parent, Key, Props> : Type extends undefined ? WriteFieldUndefined<Parent, Key> : Type extends Date | Ref<any> | string | boolean | null ? WriteFieldAsIs<Parent, Key> : Type extends Array<infer ItemType> ? WriteFieldArray<Parent, Key, ItemType> : Type extends object ? WriteFieldObject<Parent, Key, Type, Props> : never;
    /**
     * Write field object. Resolves object union with special value types.
     */
    export type WriteFieldObject<Parent, Key extends keyof Parent, Type extends ModelObjectType, Props extends DocProps> = WriteData<Type, Props> | MaybeValueRemove<Parent, Key>;
    /**
     * Number write field. Resolves number union with special value types.
     */
    export type WriteFieldNumber<Parent, Key extends keyof Parent, Type extends number> = Parent[Key] | ValueIncrement<Type> | MaybeValueRemove<Parent, Key>;
    /**
     ...
     */
    export type WriteFieldServerDate<Parent, Key extends keyof Parent, Props extends DocProps> = Props["environment"] extends "server" ? Date | ValueServerDate | MaybeValueRemove<Parent, Key> : ValueServerDate | MaybeValueRemove<Parent, Key>;
    /**
     * Undefined write field. Resolves undefined union with special value types.
     */
    export type WriteFieldUndefined<Parent, Key extends keyof Parent> = (Utils.ActuallyUndefined<Parent, Key> extends true ? undefined | null : never) | MaybeValueRemove<Parent, Key>;
    /**
     * As-is write field. Resolves as-is types union with special value types.
     */
    export type WriteFieldAsIs<Parent, Key extends keyof Parent> = Exclude<Parent[Key], undefined> | MaybeValueRemove<Parent, Key>;
    /**
     * Array write field. Resolves array union with special value types.
     */
    export type WriteFieldArray<Parent, Key extends keyof Parent, ItemType> = Array<WriteArrayItem<ItemType>> | ValueArrayUnion<WriteArrayItem<ItemType>> | ValueArrayRemove<WriteArrayItem<ItemType>> | MaybeValueRemove<Parent, Key>;
    /**
     * Array write item type. Unlike {@link WriteField} it disallows arrays,
     * server dates and other special value types.
     */
    export type WriteArrayItem<Type> = Type extends ServerDate | Array<any> ? never : Type extends Date | Ref<any> | string | number | boolean | null | undefined ? Type : Type extends object ? WriteArrayItemObject<Type> : never;
    /**
     ...
     */
    export type WriteArrayObjectField<Type> = Type extends Array<infer Item> ? Array<WriteArrayItem<Item>> : WriteArrayItem<Type>;
    /**
     * Resolves the remove type value unless the key is required.
     */
    export type MaybeValueRemove<Parent, Key extends keyof Parent> = Utils.RequiredKey<Parent, Key> extends true ? never : ValueRemove;
    /**
    ...
    export interface SchemaHelpers {
        collection<Model extends ModelType, CustomId extends CustomIdConstrain = false>(): PlainCollection<Model, CustomId>;
    }
    ...
    export interface SubscriptionPromise<Request, Result, SubscriptionMeta = undefined> extends Promise<Result> {
        request: Request;
        on: SubscriptionPromiseOn<Request, Result, SubscriptionMeta>;
    }
    export interface SubscriptionPromiseOn<Request, Result, SubscriptionMeta = undefined> {
        (callback: SubscriptionPromiseCallback<Result, SubscriptionMeta>): OffSubscriptionWithCatch;
        request: Request;
    }
    export type SubscriptionPromiseCallback<Result, SubscriptionMeta = undefined> = SubscriptionMeta extends undefined ? (result: Result) => void : (result: Result, meta: SubscriptionMeta) => void;
    ...
    export interface DocAPI<Def extends DocDef> {
        get<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(options?: ReadOptions<Environment, Props>): SubscriptionPromise<GetRequest, Doc<Def, Props> | null>;
        set<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(data: AssignArg<UnionVariableModelType<Def["WideModel"]>, Props>, options?: OperationOptions<Environment>): Promise<Ref<Def>>;
        upset<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(data: AssignArg<UnionVariableModelType<Def["WideModel"]>, Props>, options?: OperationOptions<Environment>): Promise<Ref<Def>>;
        update: Update.DocFunction<Def>;
        remove(): Promise<Ref<Def>>;
        narrow<NarrowToModel extends ModelType>(fn: DocNarrowFunction<IntersectVariableModelType<Def["WideModel"]>, NarrowToModel>): Doc<{
            Model: NarrowToModel;
            Name: Def["Name"];
            Id: Def["Id"];
            WideModel: Def["WideModel"];
    ...
    export type DocNarrowFunction<InputModel extends ModelType, ExpectedModel extends ModelType> = (data: InputModel) => false | Nullify<ExpectedModel>;
    export interface CollectionAPI<Def extends DocDef> {
        all<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(options?: ReadOptions<Environment, Props>): SubscriptionPromise<AllRequest, Doc<Def, Props>[], SubscriptionListMeta<Def, Props>>;
    ...
    export interface Collection<Def extends DocDef> extends CollectionAPI<Def> {
        ...
        get<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(id: Def["Id"], options?: ReadOptions<Environment, Props>): SubscriptionPromise<GetRequest, Doc<Def, Props> | null>;
        many<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(ids: Def["Id"][], options?: ReadOptions<Environment, Props>): SubscriptionPromise<ManyRequest, Array<Doc<Def, Props> | null>>;
        add<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(data: AssignArg<UnionVariableModelType<Def["Model"]>, Props>, options?: OperationOptions<Environment>): Promise<Ref<Def>>;
        set<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(id: Def["Id"], data: AssignArg<UnionVariableModelType<Def["WideModel"]>, Props>, options?: OperationOptions<Environment>): Promise<Ref<Def>>;
        upset<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(id: Def["Id"], data: AssignArg<UnionVariableModelType<Def["WideModel"]>, Props>, options?: OperationOptions<Environment>): Promise<Ref<Def>>;
        ...
        doc<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(snapshot: Firebase.Snapshot): Doc<Def, Props> | null;
        doc<Environment extends RuntimeEnvironment, Props extends DocProps & {
            environment: Environment;
        }>(id: Def["Id"], data: DocData<Def, Props>, options?: OperationOptions<Environment>): Doc<Def, Props>;
        /**
    ...
    export interface NestedCollection<Def extends DocDef, Schema extends AnyDB> extends Collection<Def> {
        (id: Def["Id"]): Schema;
        schema: Schema;
        sub: NestedCollectionShortcuts<Schema>;
    }
    export type NestedCollectionShortcuts<Schema extends AnyDB> = {
        [Path in keyof Schema]: Path extends string ? Schema[Path] extends NestedCollection<infer Def, infer Schema> ? NestedCollectionShortcut<Def, Schema> : Schema[Path] extends Collection<infer Def> ? CollectionShortcut<Def> : Schema[Path] : never;
    };
    ...
    export interface NestedCollectionShortcut<Def extends DocDef, Schema extends AnyDB> extends CollectionShortcut<Def> {
        sub: NestedCollectionShortcuts<Schema>;
    }
    export type AnyCollection<Def extends DocDef> = Collection<Def> | NestedCollection<Def, AnyDB>;
    export interface PlainCollection<Model extends ModelType, CustomId extends CustomIdConstrain = false, CustomName extends string | false = false> {
        /** The collection type */
        type: "collection";
        sub<Schema extends PlainSchema>(schema: Schema): NestedPlainCollection<Model, Schema, CustomId, CustomName>;
        name<Name extends string>(name: Name): PlainCollection<Model, CustomId, Name>;
    }
    export interface NestedPlainCollection<_Model extends ModelType, Schema extends PlainSchema, _CustomId extends CustomIdConstrain = false, _CustomName extends string | false = false> {
        /** The collection type */
        type: "collection";
        schema: Schema;
    }
    export type AnyPlainCollection = PlainCollection<any> | NestedPlainCollection<any, PlainSchema>;
    export interface PlainSchema {
        [Path: string | symbol]: PlainCollection<any> | NestedPlainCollection<any, PlainSchema>;
    }
    export interface AnyDB {
        [CollectionPath: string]: AnyCollection<any>;
    }
    export type DB<Schema, BasePath extends string | false = false> = {
        [Name in keyof Schema]: Name extends string ? Schema[Name] extends NestedPlainCollection<infer Model, infer Schema, infer CustomId, infer CustomName> ? NestedCollection<CollectionDef<Name, Model, CustomId, CustomName, BasePath>, DB<Schema, Utils.ComposePath<BasePath, Name>>> : Schema[Name] extends PlainCollection<infer Model, infer CustomId, infer CustomName> ? Collection<CollectionDef<Name, Model, CustomId, CustomName, BasePath>> : never : never;
    };
    /**
     * Resolves collection def.
     */
    export type CollectionDef<Name extends string, Model extends ModelType, CustomId, CustomName, BasePath extends string | false> = {
        Model: NullifyModel<Model>;
        Name: CustomName extends string ? CustomName : Name;
        Id: CustomId extends Id<any> | string ? CustomId : Id<Utils.ComposePath<BasePath, Name>>;
    ...
    export type InferSchema<DB extends TypesaurusCore.DB<any, any>> = {
        [Path in keyof DB]: DB[Path] extends Collection<infer Def> | NestedCollection<infer Def, any> ? {
            /**
             * The type allows to access subcollections.
             *
             * [Learn more on the docs website](https://typesaurus.com/types/schema/#subcollections)
             */
            sub: DB[Path] extends NestedCollection<any, infer Schema extends TypesaurusCore.DB<any, any>> ? InferSchema<Schema> : never;
            /**
             ...
             */
            Data: Data<IntersectVariableModelType<Def["Model"]>, ServerDateMissing>;
            /**
             ...
             */
            AssignArg: AssignArg<IntersectVariableModelType<Def["Model"]>, DocProps>;
            /**
             ...
             */
            AssignData: WriteData<IntersectVariableModelType<Def["Model"]>, DocProps>;
            /**
             ...
             */
            AssignGetter: AssignGetter<IntersectVariableModelType<Def["Model"]>, DocProps>;
            /**
             ...
             */
            UpdateData: Update.Data<IntersectVariableModelType<Def["Model"]>, DocProps>;
            /**
             ...
             */
            ServerDoc: TypesaurusCore.Doc<Def, DocProps & {
                environment: "server";
            }>;
            /**
             ...
             */
            ServerAssignArg: AssignArg<IntersectVariableModelType<Def["Model"]>, DocProps>;
            /**
             ...
             */
            ServerAssignData: WriteData<IntersectVariableModelType<Def["Model"]>, DocProps & {
                environment: "server";
            }>;
            /**
             ...
             */
            ServerAssignGetter: AssignGetter<IntersectVariableModelType<Def["Model"]>, DocProps & {
                environment: "server";
            }>;
            /**
             ...
             */
            ServerUpdateBuilder: Update.Builder<Def, DocProps & {
                environment: "server";
            }>;
            /**
             ...
             */
            ServerUpdateArg: Update.Arg<Def, DocProps & {
                environment: "server";
            }>;
            /**
             ...
             */
            ServerUpdateData: Update.Data<Def, DocProps & {
                environment: "server";
            }>;
            /**
             ...
             */
            ServerUpdateGetter: Update.ArgGetter<Def, DocProps & {
                environment: "server";
            }>;
            /**
             ...
             */
            ServerUpdateHelpers: Update.Helpers<Def, DocProps & {
                environment: "server";
            }>;
            /**
     ...
     */
    export type NarrowDoc<OriginalDoc extends Doc<any, any>, NarrowToModel extends ModelObjectType> = OriginalDoc extends Doc<infer Def extends DocDef, infer Props extends DocProps> ? NarrowToModel extends IntersectVariableModelType<Def["WideModel"]> ? Doc<{
        Model: NarrowToModel;
        Name: Def["Name"];
        Id: Def["Id"];
        WideModel: Def["WideModel"];
     ...
     * are not allowed).
     */
    export type NormalizeServerDates<Type> = Type extends ServerDate ? Date : Type extends Date | Ref<any> | string | number | boolean ? Type : Type extends Array<infer Item> ? Array<NormalizeServerDates<Item>> : Type extends object ? {
     ...
     */
    export type Nullify<Type> = Type extends null | undefined ? Type | null : Type extends ServerDate | Date | Ref<any> | string | number | boolean ? Type : Type extends Array<infer Item> ? Array<Nullify<Item>> : Type extends object ? {
        [Key in keyof Type]: Utils.ActuallyUndefined<Type, Key> extends true ? Nullify<Type[Key]> : Nullify<Exclude<Type[Key], undefined>>;
    } : never;
    /**
     * Deeply adds null to shapes of a variable model.
     */
    export type NullifyModel<Model extends ModelType> = Model extends ModelObjectType ? Nullify<Model> : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType,
        ...
        infer D extends ModelObjectType,
        infer E extends ModelObjectType
    ] ? [Nullify<A>, Nullify<B>, Nullify<C>, Nullify<D>, Nullify<E>] : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType,
        infer D extends ModelObjectType
    ] ? [Nullify<A>, Nullify<B>, Nullify<C>, Nullify<D>] : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType,
        infer C extends ModelObjectType
    ] ? [Nullify<A>, Nullify<B>, Nullify<C>] : Model extends [
        infer A extends ModelObjectType,
        infer B extends ModelObjectType
    ] ? [Nullify<A>, Nullify<B>] : Model extends [infer A extends ModelObjectType] ? [Nullify<A>] : never;
    export {};
}
